...
export const INVESTIGATION_SYSTEM_PROMPT = [
  ...
  "If the timeline names a pull request, inspect that PR. If a PR is merged, inspect files and commits. If there is no PR, check comments, then stop if evidence is still missing.",
